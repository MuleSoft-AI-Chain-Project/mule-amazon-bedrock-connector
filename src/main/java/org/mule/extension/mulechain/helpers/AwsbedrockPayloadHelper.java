...
public class AwsbedrockPayloadHelper {
  ...
  public static String invokeModel(String prompt, AwsbedrockConfiguration configuration,
    ...
    try {
      ...
      System.err.printf("ERROR: Can't invoke '%s'. Reason: %s", awsBedrockParameters.getModelName(),
                        e.getMessage());
      throw new RuntimeException(e);
    }
  }

  private static String formatBedrockResponse(AwsbedrockParameters awsBedrockParameters,
    ...
    try {
      ...
      GetFoundationModelResponse response = bedrockClient.getFoundationModel(
                                                                             GetFoundationModelRequest.builder()
                                                                                 .modelIdentifier(awsBedrockParameters
                                                                                     .getModelName())
                                                                                 .build());
